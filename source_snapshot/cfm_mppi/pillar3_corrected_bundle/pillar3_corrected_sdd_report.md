# Corrected Pillar-3 verifier on eval80 SDD
...
- `dataset`: sdd
- `ego_path`: /mnt/data/eval80_ego_sdd.pt
- `obs_path`: /mnt/data/eval80_obs_sdd.pkl
- `n_cases`: 25
- `gamma`: 0.5
- `sensing`: 2.0
- `horizon`: 10
...
- `verifier_success`: 21
- `verifier_failure`: 4
- `verifier_success_rate`: 0.84
- `verifier_mean_time_ms`: 8.482432714161058
- `verifier_median_time_ms`: 7.498027999645274
- `verifier_max_time_ms`: 30.327121000482293
- `verifier_mean_lp_time_ms`: 1.4496043809880834
- `mppi_mean_time_ms`: 3.1251241999780177
- `mean_accepted`: 127.32
- `mean_rejected`: 128.68
- `nominal_certified_count`: 20
- `failures`: [{'ep': 233, 't': 43, 'reason': 'LP_infeasible'}, {'ep': 184, 't': 25, 'reason': 'no_positive_tangent_margin'}, {'ep': 132, 't': 8, 'reason': 'no_positive_tangent_margin'}, {'ep': 293, 't': 29, 'reason': 'no_positive_tangent_margin'}]
